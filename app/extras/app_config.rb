class AppConfig
  ...
  def self.theme
    {
      site_name:                         ENV.fetch('SITE_NAME',                     'Asamblea'),
      ...
      default_group_cover_src:           ENV.fetch('THEME_DEFAULT_GROUP_COVER_SRC', '/theme/default_group_cover.jpg'),
      ...
      primary_color:                     ENV.fetch('THEME_PRIMARY_COLOR',           '#66bb6a'),
